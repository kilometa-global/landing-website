...
<div class="container pt-10 my-10">
    <div class="row">
        <div class="col-12 m-auto">
            ...
            <p>
                I understand that Kilometa, LLC. (‘Company’) will use Checkr., (‘Checkr, Inc.’) to obtain a motor vehicle record as part of the application process to be a driver on the Kilometa Platform (a ‘Driver’). I also understand that if accepted as a Driver, to the extent permitted by law, Company may obtain further Reports from Checkr Inc. so as to update, renew or extend my status as a Driver. I hereby give permission to Kilometa to obtain my state driving record (also known as my motor vehicle record or MVR) in accordance with the Federal Driver’s Privacy Protection Act (‘DPPA’) and applicable state law. I acknowledge and understand that my driving record is a consumer report that contains public record information. I authorize, without reservation any party or agency contacted by Company or Checkr Inc. to furnish Company a copy of my state driving record. This authorization shall remain on file by Company for the duration of my time as a Driver, and will serve as ongoing authorization for Company to procure my state driving record at any time while I am a Driver.
            </p>
            <h4>
                Consent to Request Consumer Report or Investigative Consumer Report Information
            </h4>
            <p>I understand that Kilometa, LLC. (‘Company’) will use Checkr Inc.,</p>
            <p>1 Montgomery St, Ste 2000, San Francisco, CA 94104</p>
            <p>to obtain a consumer report or investigative consumer report as part of the application process to be a driver on the Kilometa Platform (a ‘Driver’). I also understand that if accepted as a Driver, to the extent permitted by law, Company may obtain further Reports from Checkr so as to update, renew or extend my status as a Driver.</p>
